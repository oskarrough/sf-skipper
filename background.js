...
async function openPaletteInTab(tab) {
  ...
  try {
    ...
    await chrome.scripting.executeScript({
      target: { tabId: tab.id },
      world: 'ISOLATED',
      files: ['salesforce-urls.js', 'shared.js', 'cache-factory.js', 'objects.js', 'cmdt.js', 'flows.js', 'apps.js', 'labels.js', 'permsets.js', 'flow-debug.js', 'commands.js', 'org-glossary.js', 'org-glossary-extractors.js', 'soql.js', 'ask.js', 'markdown.js', 'onboarding.js', 'content.js'],
    });
